	...
	<div class="container-fluid mt-5">
		<div class="row pt-4 ">
			...
			<form id="product" class="jumbotron pt-4 pb-5">
				...
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" >Price + GST</span>
				  </div>
				  <input type="number" class="form-control" step=".01" id="product_price" placeholder="123.56" >
				</div>
				...
				<div class="input-group mb-3">
				  ...
				  <input type="number" class="form-control" step=".01" name="gst" id="product_gst" placeholder="5,12,18..." required>
				</div>
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" >Price</span>
				  </div>
				  <input type="number" class="form-control" step=".01" name="price"  id="product_price_nogst" placeholder="without GST" required>
				</div>
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" >HSN</span>
				  </div>
				  <input type="text" class="form-control"  name="hsn" id="product_hsn" placeholder="12345678" required>
				</div>
...
$(document).on("keyup","#product_price",function(){
	...
	var nogst=$("#product_price_nogst");
	if(gst.val()!="" && price.val()!=""){
		
		var calc=price.val()*100/(100+parseInt(gst.val()));
		nogst.val(calc.toFixed(2));
	}
})
$(document).on("keyup","#product_gst",function(){
	var gst=$("#product_gst");
	var price = $("#product_price");
	var nogst=$("#product_price_nogst");
	if(gst.val()!="" && price.val()!=""){
		...
		$.ajax({
			...
			success:function(data){
				...
				if(data!="" ){
					...
					$("#product_gst").val(product_json[9])
					$("#product_hsn").val(product_json[8])
					$("#product_price_nogst").val(product_json[3])
