		...
		<div class="col-md-3">
			...
			<h2 class="text-center mb-4">Add Product</h2>
				...
				<div class="input-group mb-3">
				  ...
				  <input type="number" class="form-control" step=".01" name="add_item_price_gst" id="product_price" placeholder="with GST" required>
				</div>
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" >GST</span>
				  </div>
				  <input type="number" class="form-control" step=".01" name="add_item_gst"  id="product_gst" placeholder="5,12,18..." required>
				</div>
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" >Price</span>
				  </div>
				  <input type="number" class="form-control" step=".01" name="add_item_price" id="product_price_nogst" placeholder="without GST" required>
				</div>
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" >HSN</span>
				  </div>
				  <input type="text" class="form-control" step=".01" name="add_item_hsn" id="product_hsn" placeholder="12345678" required>
				</div>
...
$(document).on("keyup","#product_price",function(){
	...
	if(gst.val()!="" && price.val()!=""){
		...
		var calc=price.val()*(100/(100+parseInt(gst.val()))).toFixed(2);
